...
if scriptDebug then Helios.log.write(thisScript,"LuaExportStart() invoked.") end
...
LuaExportBeforeNextFrame= function()
	if scriptDebug then Helios.log.write(thisScript,"LuaExportBeforeNextFrame() invoked.") end
	ProcessInput()
...
LuaExportAfterNextFrame= function()
	if scriptDebug then Helios.log.write(thisScript,"LuaExportAfterNextFrame() invoked.") end
...
LuaExportStop= function()
	if scriptDebug then Helios.log.write(thisScript,"LuaExportStop() invoked.") end
...
LuaExportActivityNextEvent= function(t)
	if scriptDebug then Helios.log.write(thisScript,"LuaExportActivityNextEvent() invoked.") end
	if scriptDebug and c == nil then Helios.log.write(thisScript,"Connection object is Nil in LuaExportActivityNextEvent().") end
...
SendData = function(id, value)
    --Helios.log.write(thisScript,"Pre SendData: " .. id .. "=" .. value)
